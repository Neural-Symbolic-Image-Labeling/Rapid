...
def get_total_list1(input_list):
    ...
    for image_num in range(len(input_list)):
        ...
        for name in input_list[image_num]['object_detect']:
            ...
            t=input_list[image_num]['object_detect'][name]
            if (a=='has_size' and t!='very_small_(3_-_5_in)' and t!='small_(5_-_9_in)') or\
                   (a=='has_shape' and t!='perching-like' and t!='tree-clinging-like' and t!='pigeon-like' and t!='swallow-like')\
                   or (a=='has_head_pattern' and t!='eyering' and t!='eyeline' and t!='eyebrow' and t!='masked' and t!='malar')\
                   or (a=='has_bill_color' and t!='black' and t!='grey' and t!='buff' and t!='yellow') \
                   or (a=='has_leg_color' and t!='black' and t!='buff' and t!='yellow')\
                   or (a=='has_primary_color' and t!='grey' and t!='yellow' and t!='black' and t!='green' and t!='white')\
                   or (a=='has_belly_color' and t!='green' and t!='buff' and t!='yellow')\
                   or (a=='has_under_tail_color' and t!='black' and t!='buff' and t!='yellow') \
                   or (a=='has_nape_color' and t!='black' and t!='grey' and t!='white' and t!='yellow')\
                   or (a=='has_forehead_color' and t!='black' and t!='grey' and t!='olive' and t!='yellow' and t!='iridescent') \
                   or (a=='has_eye_color' and t!='black' and t!='brown') \
                   or (a=='has_throat__color' and t!='yellow' and t!='buff' and t!='white')\
                   or (a=='has_breast_color' and t!='black' and t!='white' and t!='buff' and t!='yellow' and t!='green')\
                   or (a=='has_underparts_color' and t!='yellow' and t!='green')\
                   and a!='has_crown_color' and a!='has_breast_pattern' and a!='has_tail_pattern' and a!='has_belly_pattern' and a!="has_wing_pattern" and a!='has_wing_shape':
