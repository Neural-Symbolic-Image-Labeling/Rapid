...
from al.strategies.informativeness import *
from al.strategies.utils import *
from al.strategies.representativeness import *
...
class Config:
    def __init__(self):
        self.data_path = "FOIL/data_file/bird/bird_171172173.json"
        self.split_config_path = "FOIL/data_file/bird/config_bird_171172173.json"
        self.foil_model: str = 'bird3'    # Choose foil and label functions from
                                # ['ad_prof', 'ad_prof_neg_color', 'ad_prof_neg_nocolor', 'bird', 'medical']
        self.n_init = 3
        self.n_query_total = 96
        ...
        self.output_file = f"bird171172173_bird3_3+3x32_{self.testround}rounds.json"
